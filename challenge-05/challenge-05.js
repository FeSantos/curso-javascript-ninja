...
*/
var array = ["Fernando", 30, 1.89, "Matheus", "branco"];
...
*/
console.log(myFunction(array)[1]); // 30
...
*/
var array2 = ["Matheus", 1, 1, "Fernando", "branco"];
...
function book(name) {
  ...
  return book[name] ? book[name] : book;
}
...
*/
console.log(book("Clean Code").quantidadePaginas);
...
*/
var nomeLivro = "O Poder do Hábito";
console.log(
